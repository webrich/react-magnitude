...
import { Container, Row, Column, Divider, Section } from 'react-magnitude';
...
<Example title='Grid'>
    ...
    <Section>
        <Row>
            <Column size="s6" offset="s6">6-columns (offset-by-6)</Column>
        </Row>
    </Section>
    <Divider/>
    <Section>
        <Row>
            <Column size="s7" push="s5">This div is 7-columns wide on pushed to the right by 5-columns.</Column>
            <Column size="s5" pull="s7">5-columns wide pulled to the left by 7-columns.</Column>
        </Row>
    </Section>
    <Divider/>
    <Section>
