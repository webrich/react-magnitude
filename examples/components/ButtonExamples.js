...
import { Row, Column, Section, Heading, Button, FAB, Icon } from "react-magnitude";
...
export default () =>
    <Example title="Buttons">
        ...
        <Section>
            ...
            <Button waves="light">
                <Icon placement="left">cloud</Icon>
                button
            </Button>{" "}
            <Button waves="light">
        ...
        <Section>
            <Button waves="light" type="submit" name="action">
                Submit
                <Icon placement="right">send</Icon>
            </Button>
        </Section>
        <Heading weight="3" className="header">
            Large
        ...
        <Section>
            <FAB>
                <Button floating size="large" color="red">
                    <Icon size="large">mode_edit</Icon>
                </Button>
                <FAB.Actions>
