...
import { Row, Column, Section, Heading, Button, Tooltip, Badge, Icon, Node, Divider } from "react-magnitude";
        ...
        <Section>
            <Column size="s3" align="center">
                <Tooltip target="#bottom-tooltip-target-2" position="bottom" html>
                    <Node textColor="teal">I am an HTML tooltip</Node>
                    <Divider />
                </Tooltip>
            ...
            <Column size="s3" align="center">
                <Tooltip target="#right-tooltip-target-2" position="right" html>
                    <Icon placement="right">send</Icon>I am an HTML tooltip
                </Tooltip>
